...
function Kevin(){
    ...
    return(
        <div className="flex items-center justify-center w-full h-screen text-white bg-slate-900">
            ...
            <a href='niavo.kevin9@gmail.com' target='_blank' rel='noopener noreferrer' className='absolute right-5 top-5 animate-bounce' title='Contactez'><i className="text-5xl text-slate-700 lg:text-white fas fa-envelope"></i></a>
        </div>
    );
}
